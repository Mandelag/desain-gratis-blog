...
0.9995 20 13
0.9999 100 15
Table 3 Tail latency DB A vs DB B
...
0.9995 20 13
0.9999 20 21
Table 4 Tail latency DB A vs DB B
...
0.9995 200
0.9999 2000
Table 6 Example Upstream Service
...
Exercise
Given the following GRPC Benchmark results of various libraries/frameworks, can you determine which one of them is the most cost efficient? (highest throughput relative to the resource usage)
...
Table 8 My Service tail latency
